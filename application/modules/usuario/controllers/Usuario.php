        ...
        if (true) {
            ...
            if ($query = $this->usuario_model->getUsuario()) {
                foreach ($query->result() as $res) {
                    ...
                    $row->correo_usuario = $res->CORREO_USUARIO;
                    $row->nombre = $res->NOMBRE;
                    $row->apellido = $res->APELLIDO;
                    $row->ultima_conexion = $res->ULTIMA_CONEXION;
    ...
    public function insertUsuario()
    {
        if (true) {
            ...
            if (!empty($this->input->post('nombre_usuario'))) {
                $request->nombre_usuario = $this->security->xss_clean($this->input->post('nombre_usuario'));
            }

            if (!empty($this->input->post('password'))) {
                $request->password = $this->security->xss_clean($this->input->post('password'));
            }
            ...
            // if (!empty($this->input->post('apellido'))) {
            //     $request->apellido = $this->security->xss_clean($this->input->post('apellido'));
            // }
            ...
            if ($this->ion_auth->register($request->correo, $request->password, $request->correo)) {
                echo "funciona";
            } else {
                echo "no funciona";
            }
